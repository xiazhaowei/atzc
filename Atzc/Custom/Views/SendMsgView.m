...
-(void)initSubViews
{
    ...
    _msgicon.image=[UIImage imageNamed:@"msgchart"];
    _msgicon.userInteractionEnabled=YES;
    
    //添加点击事件
    UITapGestureRecognizer *tapGestureTel = [[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(SendMsg)]autorelease];
